    ...
    @if(isset($inlineEdit) && $inlineEdit)
        ...
        <div id="task-edit-{{ $task->id }}" class="task-edit-mode d-none">
            <div class="task-edit-cards-container">
                ...
                {{-- Estimated Time --}}
                <div class="task-edit-form-field">
                    <label class="task-edit-label">Estimated Time:</label>
                    <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                        <input type="number" 
                               name="estimated_time" 
                               id="estimated-time-{{ $task->id }}"
                               value="@if($task->estimated_time){{ $task->estimated_time >= 60 ? round($task->estimated_time / 60, 2) : $task->estimated_time }}@endif" 
