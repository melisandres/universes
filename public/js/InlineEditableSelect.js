window.InlineEditableSelect = {
    ...
    watch: {
        ...
        formatValue() {
            // Recalculate display value when formatValue function changes
            this.updateDisplayValue();
        }
    },
    methods: {
        updateDisplayValue() {
            if (this.formatValue) {
                this.displayValue = this.formatValue(this.value) || this.placeholder;
            } else if (this.value && this.options[this.value]) {
